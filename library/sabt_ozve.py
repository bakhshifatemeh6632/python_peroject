...
# sabt_book.close()
sabt_ozve=Tk()
sabt_ozve.geometry("700x400")
back="#DAF7A6"
sabt_ozve.config(bg=back)
label_name_ketab=Label(sabt_ozve,bg=back,fg="black",text="نام کتاب")
label_name_ketab.place(relx=0.08,rely=0.05)
entry_name_ketab=Entry(sabt_ozve)
entry_name_ketab.place(relx=0.05,rely=0.10)
label_category=Label(sabt_ozve,bg=back,fg="black",text="دسته بندی کتاب")
...
label_name_Autor=Label(sabt_ozve,bg=back,fg="black",text="نام نویسنده")
label_name_Autor.place(relx=0.55,rely=0.05)
entry_name_Autor=Entry(sabt_ozve)
entry_name_Autor.place(relx=0.50,rely=0.10)
shabak_ketab=Label(sabt_ozve,bg=back,fg="black",text="شابک کتاب")
shabak_ketab.place(relx=0.75,rely=0.05)
entry_shabak_ketab=Entry(sabt_ozve)
entry_shabak_ketab.place(relx=0.70,rely=0.10)
add_ketab=Button(sabt_ozve,bg="red",fg="black",command=add_ozve,text="ثبت کتاب")
